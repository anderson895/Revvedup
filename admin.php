...
<div class="absolute top-4 right-6 flex items-center gap-4">
    ...
    <a href="admin" class="text-white font-semibold border-b-2 border-white text-sm">Admin</a>
    <a href="employee" class="text-gray-300 hover:text-white text-sm">Employee</a>
</div>
...
<div class="flex flex-col items-center justify-center flex-grow -mt-16"> 
  ...
  <div class="bg-transparent p-6 rounded-lg w-80">
      ...
      <form action="#" method="POST" class="flex flex-col space-y-4">
        <input type="text" placeholder="username" class="px-4 py-2 rounded bg-white text-black placeholder-gray-500 focus:outline-none">
        <input type="password" placeholder="password" class="px-4 py-2 rounded bg-white text-black placeholder-gray-500 focus:outline-none">
